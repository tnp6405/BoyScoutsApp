...
ActiveRecord::Schema.define(version: 20141024004910) do

  create_table "PersonalInfo", primary_key: "pi_ssn", force: true do |t|
    t.string  "pi_name",   limit: 50
    t.string  "pi_gender", limit: 10
    t.integer "pi_age"
  end
