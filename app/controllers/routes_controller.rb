...
class RoutesController < ApplicationController
  ...
  def generatePDFForRunSheets
	...
	puts route
        @routesHash = Hash.new
        routeName=route;
	@routesHash[routeName] = Subscription.find_by_sql("SELECT * FROM routes JOIN subscriptions WHERE ( routes.route_id = subscriptions.route_id and routeName='#{routeName}' and subscription_status <> 'EXPIRED') ")
    return @routesHash
  end
  ...
  def generateCSVForRunSheets 
	...
	routeHash = Hash.new
	routeHash[routeName] = Subscription.find_by_sql("SELECT * FROM routes JOIN subscriptions WHERE ( routes.route_id = subscriptions.route_id and routeName='#{routeName}' and subscription_status <> 'EXPIRED') ")
